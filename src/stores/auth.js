...
export const useAuthStore = defineStore('auth', () => {
  ...
  // FAKE BACKEND BYPASS FOR TESTING WITHOUT A SERVER
  async function login(credentials) {
    ...
    if (email === 'admin@hrm.com' && password === 'Password123!') {
      mockUser = { first_name: 'Super', last_name: 'Admin', role: 'Admin' }
    } else if (email === 'hr@hrm.com' && password === 'Password123!') {
      mockUser = { first_name: 'Sokha', last_name: 'HR', role: 'HR' }
    }

    if (mockUser) {
      const fakeToken = 'mock-jwt-token-xyz-12345'
      ...
      error.value = 'Invalid email or password. Use the demo credentials!'
      loading.value = false
